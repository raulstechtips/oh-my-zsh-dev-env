# Generated by Powerlevel10k configuration wizard on 2024-05-23 at 14:04 EDT.
...
() {
  ...
  # Don't show context in any scenario (including SSH/remote)
  # This hides the user@hostname in Coder workspaces
  typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=
